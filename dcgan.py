...
class DCGAN():
    def __init__(self):
        ...
        self.class_names= [f for f in listdir if os.path.isdir(os.path.join(root_dir, f))]

        self.shape = (128, 128, 3)
        self.z_dim = 100

        #failed 4
        #optimizer_d = Adam(lr=0.00005, beta_1=0.1)
        #optimizer_c = Adam(lr=0.0002, beta_1=0.5)
        #failed 5
        #optimizer_d = Adam(lr=0.0001, beta_1=0.5)
        #optimizer_c = Adam(lr=0.0001, beta_1=0.5)
        #failed 6
        #optimizer_d = Adam(lr=0.0001, beta_1=0.5)
        #optimizer_c = Adam(lr=0.0002, beta_1=0.5)
...
if __name__ == '__main__':
    ...
    dcgan.train(iterations=200000+1, batch_size=32, save_interval=100,
                model_interval=10000, check_noise=check_noise, r=r,c=c)
